...
var ORIGINAL_MODULES_ARRAY = require(__dirname +
  "/../build-temp/processed_modules.json");
// An object that maps the value of the `Lesson.LessonType` attribute
// to either the string 'Lecture' or 'Tutorial'
var LESSON_TYPES_OBJECT = require(__dirname +
  "/../api-nusmods-stuff/lessonTypes.json");
var FACULTY_DEPARTMENTS_OBJECT = require(
  __dirname + "/../api-nusmods-stuff/facultyDepartments.json"
);
...
(function() {
  ...
  // write to file
  fs.writeFileSync("build-temp/modinfo.js",
    "var MODULES=" +
      JSON.stringify({
  ...
  fs.writeFileSync("build-temp/auxmodinfo.js",
