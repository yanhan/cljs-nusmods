...
// `processed_modules.json` is generated by the
// `helpers/normalize_modules_json.js` program
var ORIGINAL_MODULES_ARRAY = require(
  API_NUSMODS_FOLDER + "/processed_modules.json"
);
// An object that maps the value of the `Lesson.LessonType` attribute
// to either the string 'Lecture' or 'Tutorial'
var LESSON_TYPES_OBJECT = require(
  API_NUSMODS_FOLDER + "/lessonTypes.json"
);
var FACULTY_DEPARTMENTS_OBJECT = require(
  API_NUSMODS_FOLDER + "/facultyDepartments.json"
);
...
(function() {
  ...
  // write to file
  var destFolder = "resources/public/js/mods/" + ACAD_YEAR + "/sem" + SEM;
  mkdirp.sync(destFolder);
  fs.writeFileSync(destFolder + "/modinfo.js",
    "var MODULES=" +
      JSON.stringify({
  ...
  fs.writeFileSync(destFolder + "/auxmodinfo.js",
